...
parser.add_argument('--cosine_scale_pairs', type=float, default=20,help="Scale for cosine similarity")
parser.add_argument('--cosine_scale_components', type=float, default=20,help="Scale for cosine similarity")
...
#IMAX
parser.add_argument("--calibration_weights", type=float,default='0.00001',help="Weights for calibration")
parser.add_argument("--train_VIT",type=bool,default=False)
parser.add_argument("--smooth_factor",type = float, default=0.2,help="graph layers config")
# Hyperparameters
